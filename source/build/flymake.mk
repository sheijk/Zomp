...
flymake.ml.check:
	...
	@rm -f $(FLYMAKE_BUILD)
	@($(OCAMLC) $(CAMLC_FLAGS) -c $(CHK_SOURCES) -o /tmp/flymake_temp.cmo 2>&1) | tee $(FLYMAKE_BUILD)
...
flymake.mly.check:
	$(MENHIR) $(MENHIR_FLAGS) --ocamlc "$(OCAMLC) $(CAMLC_FLAGS)" --infer $(CHK_SOURCES)
...
check-source: flymake$(suffix $(CHK_SOURCES)).check
