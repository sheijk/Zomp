...
* To be sorted
** TODO [#A] emacs/toplevel: C-c C-s abfangen wenn toplevel schon laeuft
** TODO [#A] examples which can be browsed directly in emacs
...
** TODO [#A] zomp-newline: problem with indent (resetting pos)
** TODO [#A] fix zomp-newline
...
*** TODO [#A] parse (a b c) into (op() a b c), {a b c} into (op{} a b c), (a) into (op() a), b into b?
...
*** TODO [#A] correctly indent }
*** TODO [#B] zomp: fast doc lookup
