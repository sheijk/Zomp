...
** TODO provide a (semi) public git repo
** TODO [#A] locate cause of excessivly slow LLVM IR verification
** TODO [#A] use llvm ocaml bindings for code generation. check whether this makes IR-verification faster
** TODO [#A] performance probleme fixen
** TODO [#A] gltest.cbe.c unter windows testen
** TODO [#A] schnelle navigation im toplevel
...
** TODO [#A] ast von cstring auf string umstellen
