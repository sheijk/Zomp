...
** TODO [#A] do not allow function and variable names and constants as id of expression
   ...
   How to convert into constant and var forms? Calling an error function which
   may return a transformed sexpr?
...
** zomp-cee                                                                :cee:
*** TODO type degree := int in :=_type degree int umwandeln    :improvement:cee:
...
** BUGS
*** TODO [#A] Causes invalid llvm code when omitting "ret"                 :bug:

    (macro opseq args ... (
      (ret args)
      ))
*** TODO eval current defun fails on last func in file               :bug:emacs:
...
**** DONE [#A] foo(bar baz) auch als call parsen?
     ...
     :ARCHIVE_TIME: 2008-08-17 Sun 19:23
     :END:
**** DONE smalltalk-style grouping mit keyword: arguments
     CLOSED: [2009-03-29 Sun 03:56]
     :PROPERTIES:
     :ARCHIVE_TIME: 2009-03-29 Sun 03:56
     :END:
...
*** TODO [#A] it/the foo um auf vorherige ergebnisse zuzugreifen      :toplevel:
...
**** DONE [#A] allow immediate execution of code
     ...
     :PROPERTIES:
     :ARCHIVE_TIME: 2009-03-29 Sun 03:55
     :END:
...
* New features and design inspiration
** TODO snobol string matching ankucken                                 :design:
* Notes                                                                   :zomp:
