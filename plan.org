...
* To be sorted
** TODO [#A] implicit arguments for macros (source location from where it was invoked etc.)
...
*** TODO [#A] don't move cursor on indent. then integrate zomp-tab into zomp mode
