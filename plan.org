...
** TODO [#A] makro-system inspiration
   . Common Lisp reader macros, the proposed QuasiQuoting extensions to Template Haskell, Forth parsing words, and/or Camlp4 are things to look at in this regard.
...
** TODO [#A] red an imbiss bronko erinnern
   SCHEDULED: <2009-01-02 Fri>
...
**** TODO multiple members per line
     type Vector
       float x, y, z
     end
...
*** TODO unions
*** TODO operators for all basic types
**** TODO infix +, -, *, /, **
**** TODO prefix/postfix ++, --
*** TODO control structures [2/7]
