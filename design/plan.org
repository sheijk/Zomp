...
- [ ] add source locations to macros and Bindings.TypedefSymbol and builtin macros/types
- [ ] automatically generate source location for expressions created in macros
- [ ] "no translator matched expression" must go away
- [-] proper statistics module [[file:stats.org][Stats]]
  - [X] implement for c++, OCaml and Zomp
  - [X] add to test reports
  - [ ] move all existing stats to new system
...
- find good error handling strategy?
  ...
  - errors must to be ignored explicitly
